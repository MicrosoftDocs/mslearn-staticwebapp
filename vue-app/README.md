...
This project was created to help represent a fundamental app written with Vue. The vacations theme is used throughout the app.
...
1. Clone your new repository
   ...
   cd mslearn-staticwebapp/vue-app
   ```
