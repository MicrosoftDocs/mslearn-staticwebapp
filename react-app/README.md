...
This project was created to help represent a fundamental app written with React. The vacations theme is used throughout the app.
...
1. Clone your new repository
   ...
   cd mslearn-staticwebapp/react-app
   ```
